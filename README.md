...
<head>
  ...
  <title>GIF and Text Alignment</title>
</head>
<body>
...
<div class="container">
  <div class="text">
    ...
    <ul>
      ...
      <li>🚀 <strong>Technologies:</strong> Machine Learning and AI, Data Analytics, Deep Learning</li>
      <li>💻 <strong>Scripting:</strong> HTML 5, CSS 3, JavaScript</li>
      <li>🔧 <strong>Tools and Platforms:</strong> Power BI, SPSS, Tableau, GitHub</li>
      <li>🛢️ <strong>Databases:</strong> SQL, MongoDB, PostgreSQL</li>
      <li>🌐 <strong>Web Frameworks:</strong> Django, REST APIs</li>
    </ul>
  </div>
  <div class="gif">
    <img width="300" src="[https://example.com/your-gif.gif](https://camo.githubusercontent.com/7de37139d0b4c1ce40865e799b446c0e963a3dd8fb68d239707237c40604fa3d/68747470733a2f2f63646e2e6472696262626c652e636f6d2f75736572732f3733303730332f73637265656e73686f74732f363538313234332f6176656e746f2e676966)" alt="Your GIF Alt Text">
  </div>
</div>
